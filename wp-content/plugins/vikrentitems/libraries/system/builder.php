...
class VikRentItemsBuilder
{
	...
	public static function setupAdminMenu()
	{
		...
		add_menu_page(
			JText::_('COM_VIKRENTITEMS'), 			// page title
			JText::_('COM_VIKRENTITEMS_MENU'), 		// menu title
	...
	public static function setupHtmlHelpers()
	{
		...
		JHtml::register('renderCalendar', function($data)
		{
			...
			JHtml::_('stylesheet', VRI_SITE_URI . 'resources/jquery-ui.min.css');
		...
		JHtml::register('system.js', function()
		{
			...
			if (!$loaded)
			{
				...
				JHtml::_('script', VRI_ADMIN_URI . 'resources/js/system.js');
				JHtml::_('stylesheet', VRI_ADMIN_URI . 'resources/css/system.css');

				JHtml::_('script', VRI_ADMIN_URI . 'resources/js/bootstrap.min.js');
				JHtml::_('stylesheet', VRI_ADMIN_URI . 'resources/css/bootstrap.lite.css');
			}
		});
		...
		JHtml::register('select2', function()
		{
			 ...
			 * @since 1.2.5
			 */
			JHtml::_('script', VRI_ADMIN_URI . 'resources/select2.min.js');
			JHtml::_('stylesheet', VRI_ADMIN_URI . 'resources/select2.min.css');
		});
	}
