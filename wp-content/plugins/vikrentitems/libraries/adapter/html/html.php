...
abstract class JHtml
{
	...
	/**
	 * Proxy method for JHtml::_()
	 */
	public static function u($key)
	{
		return static::_($key);
	}
	...
	public static function loadFile($file)
	{
		...
		$path = $base . DIRECTORY_SEPARATOR . strtolower($file) . '.php';
		...
		{
			/**
			 * Try to look on other custom folders.
			 *
			 * @since 10.1.29
			 */
			$path = JPath::find(static::addIncludePath(), strtolower($file) . '.php');
...
JS
		 ...
		 */
		return static::_('renderCalendar', $data);
	}
