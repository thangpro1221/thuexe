...
<div class="vri-dashboard-fullcontainer">
	<div class="vri-dashboard-today-bookings">
		...
		<div class="vri-dashboard-today-pickup-wrapper">
			<h4><?php VikRentItemsIcons::e('sign-in'); ?> <?php echo JText::_('VRIDASHTODAYPICKUP'); ?></h4>
			<div class="vri-dashboard-today-pickup table-responsive">
				...
				foreach ($pickup_today as $next) {
					...
					$status_lbl = '<span class="label label-success vri-status-label">'.strtoupper(JText::_('VRIONFIRMED')).'</span>';
					if ($next['status'] == 'standby') {
						$status_lbl = '<span class="label label-warning vri-status-label">'.strtoupper(JText::_('VRSTANDBY')).'</span>';
					} elseif ($next['status'] == 'cancelled') {
						$status_lbl = '<span class="label label-error vri-status-label">'.strtoupper(JText::_('VRCANCELLED')).'</span>';
					}
					?>
		...
		<div class="vri-dashboard-today-dropoff-wrapper">
			<h4><?php VikRentItemsIcons::e('sign-out'); ?> <?php echo JText::_('VRIDASHTODAYDROPOFF'); ?></h4>
			<div class="vri-dashboard-today-dropoff table-responsive">
				<table class="table">
					<tr class="vri-dashboard-today-dropoff-firstrow">
						<td class="left"><?php echo JText::_('VRIDASHUPRESONE'); ?></td>
						<td class="left"><?php echo JText::_('VRIDASHUPRESTWO'); ?></td>
						<td class="left"><?php echo JText::_('VRPVIEWORDERSTWO'); ?></td>
						<td class="center"><?php echo JText::_('VRIDASHUPRESTHREE'); ?></td>
						<td class="center"><?php echo JText::_('VRIDASHUPRESFOUR'); ?></td>
						<td class="center"><?php echo JText::_('VRIDASHUPRESFIVE'); ?></td>
					</tr>
				<?php
	...
	<div class="vri-dashboard-next-bookings-block">
		<div class="vri-dashboard-next-bookings table-responsive">
			<h4><?php VikRentItemsIcons::e('calendar'); ?> <?php echo JText::_('VRIDASHUPCRES'); ?></h4>
	...
	<div class="vridashdivright">
		<h4><?php VikRentItemsIcons::e('tasks'); ?> <?php echo JText::_('VRIDASHSTATS'); ?></h4>
		<div class="vri-dash-reports">
		<?php
		if ($arrayfirst['totprices'] < 1) {
			?>
			<p class="vridashparagred">
				<span class="vri-dash-report-lbl"><?php echo JText::_('VRIDASHNOPRICES'); ?></span>
				<span class="vri-dash-report-val">0</span>
				<a href="index.php?option=com_vikrentitems&task=prices" class="button button-secondary"><?php echo JText::_('VRICONFIGURETASK'); ?></a>
			</p>
			<?php
		}
		if ($arrayfirst['totlocations'] < 1 && $arrayfirst['totitems'] < 1) {
			?>
			<p class="vridashparagred">
				<span class="vri-dash-report-lbl"><?php echo JText::_('VRIDASHNOLOCATIONS'); ?></span>
				<span class="vri-dash-report-val">0</span>
				<a href="index.php?option=com_vikrentitems&task=places" class="button button-secondary"><?php echo JText::_('VRICONFIGURETASK'); ?></a>
			</p>
			<?php
		} else {
			?>
		...
		if ($arrayfirst['totcategories'] < 1) {
			?>
			<p class="vridashparagred">
				<span class="vri-dash-report-lbl"><?php echo JText::_('VRIDASHNOCATEGORIES'); ?></span>
				<span class="vri-dash-report-val">0</span>
				<a href="index.php?option=com_vikrentitems&task=categories" class="button button-secondary"><?php echo JText::_('VRICONFIGURETASK'); ?></a>
			</p>
			<?php
		} else {
			?>
		...
		if ($arrayfirst['totitems'] < 1) {
			?>
			<p class="vridashparagred">
				<span class="vri-dash-report-lbl"><?php echo JText::_('VRIDASHNOITEMS'); ?></span>
				<span class="vri-dash-report-val">0</span>
				<a href="index.php?option=com_vikrentitems&task=items" class="button button-secondary"><?php echo JText::_('VRICONFIGURETASK'); ?></a>
			</p>
			<?php
		} else {
			?>
		...
		if ($arrayfirst['totdailyfares'] < 1) {
			?>
			<p class="vridashparagred">
				<span class="vri-dash-report-lbl"><?php echo JText::_('VRIDASHNODAILYFARES'); ?></span>
				<span class="vri-dash-report-val">0</span>
				<a href="index.php?option=com_vikrentitems&task=tariffs" class="button button-secondary"><?php echo JText::_('VRICONFIGURETASK'); ?></a>
			</p>
			<?php
		}
		if (count($shortcodes) < 1) {
			...
			?>
			<p class="vridashparagred">
				<span class="vri-dash-report-lbl"><?php echo JText::_('VRIFIRSTSETSHORTCODES'); ?></span>
				<span class="vri-dash-report-val">0</span>
				<a href="index.php?option=com_vikrentitems&view=shortcodes" class="button button-secondary"><?php echo JText::_('VRICONFIGURETASK'); ?></a>
			</p>
			<?php
		} else {
		?>
			<p class="vridashparag">
				<span class="vri-dash-report-lbl"><?php echo JText::_('VRIDASHTOTRESCONF'); ?></span>
				<span class="vri-dash-report-val"><?php echo $totnextrentconf; ?></span>
			</p>
			<p class="vridashparag">
				<span class="vri-dash-report-lbl"><?php echo JText::_('VRIDASHTOTRESPEND'); ?></span>
