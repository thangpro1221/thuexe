				...
				<div class="vri-params-wrap">
					...
					<div class="vri-params-container">
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VREDITPLACEONE'); ?></div>
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRILOCADDRESS'); ?></div>
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPLACELAT'); ?></div>
							<div class="vri-param-setting"><input type="text" name="lat" value="<?php echo count($row) ? $row['lat'] : ''; ?>" size="30"/></div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPLACELNG'); ?></div>
							<div class="vri-param-setting"><input type="text" name="lng" value="<?php echo count($row) ? $row['lng'] : ''; ?>" size="30"/></div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPLACEOVERRIDETAX'); ?> <?php echo $vri_app->createPopover(array('title' => JText::_('VRIPLACEOVERRIDETAX'), 'content' => JText::_('VRIPLACEOVERRIDETAXTXT'))); ?></div>
							<div class="vri-param-setting"><?php echo $wiva; ?></div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPLACEDESCR'); ?></div>
		...
		<div class="vri-config-maintab-right">
			<fieldset class="adminform">
				<div class="vri-params-wrap">
					...
					<div class="vri-params-container">
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPLACEOPENTIME'); ?> <?php echo $vri_app->createPopover(array('title' => JText::_('VRIPLACEOPENTIME'), 'content' => JText::_('VRIPLACEOPENTIMETXT'))); ?></div>
							<div class="vri-param-setting">
								<table style="width: auto !important;">
									<tr>
										<td style="vertical-align: middle;"><?php echo JText::_('VRIPLACEOPENTIMEFROM'); ?>:</td>
									...
									<tr>
										<td style="vertical-align: middle;"><?php echo JText::_('VRIPLACEOPENTIMETO'); ?>:</td>
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPLACESUGGOPENTIME'); ?> <?php echo $vri_app->createPopover(array('title' => JText::_('VRIPLACESUGGOPENTIME'), 'content' => JText::_('VRIPLACESUGGOPENTIMETXT'))); ?></div>
							<div class="vri-param-setting">
								<select name="suggopentimeh"><?php echo $sugghours; ?></select>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPLACEOVROPENTIME'); ?> <?php echo $vri_app->createPopover(array('title' => JText::_('VRIPLACEOVROPENTIME'), 'content' => JText::_('VRIPLACEOVROPENTIMEHELP'))); ?></div>
							<div class="vri-param-setting">
									...
									<div class="vri-param-loc-wopening-wday">
										...
										<div class="vri-param-loc-wopening-wday-override" style="display: <?php echo isset($wopening[$d_ind]) ? 'block' : 'none'; ?>;" id="wopening-<?php echo $d_ind; ?>">
											<div class="vri-param-marginbottom">
												<span class="vrirestrdrangesp"><?php echo JText::_('VRIPLACEOPENTIMEFROM'); ?></span>
											...
											<div class="vri-param-marginbottom">
												<span class="vrirestrdrangesp"><?php echo JText::_('VRIPLACEOPENTIMETO'); ?></span>
												<span class="vri-param-loc-wopening-override-sels">
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWPLACECLOSINGDAYS'); ?> <?php echo $vri_app->createPopover(array('title' => JText::_('VRNEWPLACECLOSINGDAYS'), 'content' => JText::_('VRNEWPLACECLOSINGDAYSHELP'))); ?></div>
							<div class="vri-param-setting">
								...
								<span class="btn vri-config-btn" onclick="javascript: vriAddClosingDate();"><?php echo JText::_('VRNEWPLACECLOSINGDAYSADD'); ?></span>
