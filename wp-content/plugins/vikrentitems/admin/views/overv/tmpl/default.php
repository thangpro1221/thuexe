...
var vriMessages = {
	...
	"totalPaid": "<?php echo addslashes(JText::_('VRIEXPCSVTOTPAID')); ?>",
	...
	var jqxhr = jQuery.ajax({
		...
		if (res.indexOf('e4j.error') >= 0 ) {
			...
			jQuery(obj_res).each(function(k, v) {
				 ...
				 */
				bcont += "<div class=\"vri-overview-tip-bid\"><span class=\"vri-overview-tip-lbl\"><?php echo addslashes(JText::_('VRIDASHUPRESONE')); ?> <span class=\"vri-overview-tip-lbl-innerleft\"><a href=\"index.php?option=com_vikrentitems&task=editorder&goto=overv&cid[]="+v.id+"\"><i class=\"<?php echo VikRentItemsIcons::i('edit'); ?>\"></i></a></span></span><span class=\"vri-overview-tip-cnt\">"+v.id+"</span></div>";
				//
				bcont += "<div class=\"vri-overview-tip-bstatus\"><span class=\"vri-overview-tip-lbl\"><?php echo addslashes(JText::_('VRPVIEWORDERSEIGHT')); ?></span><span class=\"vri-overview-tip-cnt\"><div class=\"label "+(v.status == 'confirmed' ? 'label-success' : 'label-warning')+"\">"+v.status_lbl+"</div></span></div>";
				bcont += "<div class=\"vri-overview-tip-bdate\"><span class=\"vri-overview-tip-lbl\"><?php echo addslashes(JText::_('VRPVIEWORDERSONE')); ?></span><span class=\"vri-overview-tip-cnt\"><a href=\"index.php?option=com_vikrentitems&task=editorder&goto=overv&cid[]="+v.id+"\">"+v.ts+"</a></span></div>";
				bcont += "</div>";
				bcont += "<div class=\"vri-overview-tip-bookingcont-right\">";
				bcont += "<div class=\"vri-overview-tip-bcustomer\"><span class=\"vri-overview-tip-lbl\"><?php echo addslashes(JText::_('VRPVIEWORDERSTWO')); ?></span><span class=\"vri-overview-tip-cnt\">"+v.cinfo+"</span></div>";
				...
				bcont += "<div class=\"vri-overview-tip-pickdt\"><span class=\"vri-overview-tip-lbl\"><?php echo addslashes(JText::_('VRPVIEWORDERSFOUR')); ?></span><span class=\"vri-overview-tip-cnt\">"+v.pickup+"</span></div>";
				bcont += "<div class=\"vri-overview-tip-dropdt\"><span class=\"vri-overview-tip-lbl\"><?php echo addslashes(JText::_('VRPVIEWORDERSFIVE')); ?></span><span class=\"vri-overview-tip-cnt\">"+v.dropoff+"</span></div>";
