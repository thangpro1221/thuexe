...
<div class="vri-admin-wizard-container">
	...
	if (!empty($this->rows)) {
		?>
		<a class="btn vri-wizard-btn" href="index.php?option=com_vikrentitems"><?php VikRentItemsIcons::e('home'); ?> <?php echo JText::_('VRIMENUDASHBOARD'); ?></a>
		<?php
	}
	?>
		<a class="btn vri-wizard-btn" href="javascript: void(0);" onclick="showVriWizard();"><?php VikRentItemsIcons::e('magic'); ?> <?php echo JText::_('VRITOGGLEWIZARD'); ?></a>
	</div>
</div>
<?php
}
					...
					<div class="vri-param-container">
						...
						<div class="vri-param-setting">
							<div class="vri-fares-tabs">
								<div class="dailypricesactive"><?php echo JText::_('VRIDAILYFARES'); ?></div>
								<div class="hourscharges">
									<a href="index.php?option=com_vikrentitems&task=hourscharges&cid[]=<?php echo $iditem; ?>"><?php echo JText::_('VRIHOURSCHARGES'); ?></a>
								</div>
								<div class="hourlyprices">
									<a href="index.php?option=com_vikrentitems&task=tariffshours&cid[]=<?php echo $iditem; ?>"><?php echo JText::_('VRIHOURLYFARES'); ?></a>
								</div>
							</div>
						<?php
						if (empty($prices)) {
							...
							<p class="err">
								...
								<a href="index.php?option=com_vikrentitems&task=newprice"><?php echo JText::_('VRHERE'); ?></a>
							</p>
							<?php
						}
						?>
							<form name="newd" method="post" action="index.php?option=com_vikrentitems" onsubmit="javascript: if (!document.newd.ddaysfrom.value.match(/\S/)){alert('<?php echo addslashes(JText::_('VRMSGTWO')); ?>'); return false;} else {return true;}">
								<div class="vri-insertrates-cont">
									<div class="vri-insertrates-top">
										<div class="vri-ratestable-lbl"><?php echo JText::_('VRDAYS'); ?></div>
									...
									<div class="vri-insertrates-bottom">
										<div class="vri-ratestable-lbl"><?php echo JText::_('VRDAILYPRICES'); ?></div>
								...
								<div class="vri-insertrates-save">
									<input type="submit" class="btn vri-config-btn" name="newdispcost" value="<?php echo JText::_('VRINSERT'); ?>"/>
				...
				if (empty($rows)) {
					...
					<form action="index.php?option=com_vikrentitems" method="post" name="adminForm" id="adminForm" class="vri-list-form">
						<div class="vri-tariffs-updaterates-cont">
							<input type="submit" name="modtar" value="<?php echo JText::_('VRPVIEWTARTWO'); ?>" onclick="vrRateSetTask(event);" class="btn vri-config-btn" />
						</div>
