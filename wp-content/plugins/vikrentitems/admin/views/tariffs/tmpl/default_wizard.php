		...
		<div class="vri-overlay-wizard-wrap">
			<form method="post" action="index.php?option=com_vikrentitems">
				<div class="vri-tariffs-wizard-help-wrap">
					<p>
						<span><?php echo JText::_('VRIWIZARDTARIFFSMESS'); ?></span>
						<?php echo $vri_app->createPopover(array('title' => JText::_('VRINSERTFEE'), 'content' => JText::_('VRIWIZARDTARIFFSHELP'), 'placement' => 'bottom')); ?>
					</p>
					<h4><?php echo JText::_('VRIWIZARDTARIFFSWHTC'); ?></h4>
				</div>
