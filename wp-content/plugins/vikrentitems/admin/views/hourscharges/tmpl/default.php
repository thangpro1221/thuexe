			...
			<div class="vri-params-wrap">
				...
				<div class="vri-params-container vri-tariffs-params-container">
					<div class="vri-param-container">
						...
						<div class="vri-param-setting">
							<div class="vri-fares-tabs">
								<div class="dailyprices">
									<a href="index.php?option=com_vikrentitems&task=tariffs&cid[]=<?php echo $iditem; ?>"><?php echo JText::_('VRIDAILYFARES'); ?></a>
								</div>
								<div class="hourschargesactive"><?php echo JText::_('VRIHOURSCHARGES'); ?></div>
						...
						?>
							<form name="newd" method="post" action="index.php?option=com_vikrentitems" onsubmit="javascript: if (!document.newd.hhoursfrom.value.match(/\S/)){alert('<?php echo addslashes(JText::_('VRMSGTWO')); ?>'); return false;} else {return true;}">
								<div class="vri-insertrates-cont">
									<div class="vri-insertrates-top">
										<div class="vri-ratestable-lbl"><?php echo JText::_('VRIHOURS'); ?></div>
									...
									<div class="vri-insertrates-bottom">
										<div class="vri-ratestable-lbl"><?php echo JText::_('VRIHOURLYCHARGES'); ?></div>
				...
				if (empty($rows)) {
					...
					<form action="index.php?option=com_vikrentitems" method="post" name="adminForm" id="adminForm" class="vri-list-form">
						<div class="vri-tariffs-updaterates-cont">
							<input type="submit" name="modtarhourscharges" value="<?php echo JText::_('VRPVIEWTARTWO'); ?>" onclick="vrRateSetTask(event);" class="btn vri-config-btn" />
						</div>
