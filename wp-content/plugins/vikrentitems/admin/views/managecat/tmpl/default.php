						...
						<div class="vri-param-container">
							...
							<div class="vri-param-setting">
								...
								<div class="vri-param-setting-block">
									...
									<span id="resizesel" style="display: none;"><span><?php echo JText::_('VRNEWOPTTEN'); ?></span><input type="text" name="resizeto" value="250" size="3" class="vri-small-input"/> px</span>
								</div>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWCATDESCR'); ?> </div>
							<div class="vri-param-setting">
								<?php
