...
<div class="vri-choosebusy-head">
	...
	<div class="vri-choosebusy-head-bottom">
		<div class="vri-choosebusy-unitsav">
			<span class="vri-choosebusy-unitsav-txt"><?php echo JText::_('VRPCHOOSEBUSYCAVAIL'); ?>:</span>
		...
		<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped vri-list-table">
			...
			for ($i = 0, $n = count($rows); $i < $n; $i++) {
				...
				<tr class="row<?php echo $k; ?>">
					...
					if ($row['closure'] == 1) {
						?>
						<span class="vriordersitemclosed" title="<?php echo $this->escape(JText::_('VRDBTEXTROOMCLOSED')); ?>"><?php VikRentItemsIcons::e('ban'); ?> <?php echo $custdata; ?></span>
						<?php
					} else {
						echo $custdata;
					}
