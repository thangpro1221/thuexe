		...
		<div class="vikwppro-header">
			<div class="vikwppro-header-inner">
				<div class="vikwppro-header-text">
					<h2><?php echo JText::_('VRIPROTHANKSUSE'); ?></h2>
					<h3><?php echo JText::_('VRIPROTHANKSLIC'); ?></h3>
				</div>
			</div>
		</div>
		<div class="vikwppro-licencecnt">
			<div class="col col-md-6 col-sm-12 vikwppro-licencetext">
				<div>
					...
					<h4><?php echo JText::_('VRIPROGETRENEWLICFROM'); ?></h4>
					<a href="https://vikwp.com/" class="vikwp-btn-link" target="_blank"><?php VikRentItemsIcons::e('rocket'); ?> <?php echo JText::_('VRIPROGETRENEWLIC'); ?></a>
				</div>
			...
			<div class="col col-md-6 col-sm-12 vikwppro-licenceform">
				<form>				
					<div class="vikwppro-licenceform-inner">
						<h4><?php //echo JText::_('VRIPROALREADYHAVEKEY'); ?> Already have Vik Rent Items PRO? <br /> <small>Enter your licence key here</small></h4>
						<div>
							...
							<button type="button" class="btn btn-primary" id="vikwpvalidate" onclick="vikWpValidateLicenseKey();"><?php echo JText::_('VRIPROVALNUPD'); ?></button>
						</div>
					</div>
				</form>
			</div>
