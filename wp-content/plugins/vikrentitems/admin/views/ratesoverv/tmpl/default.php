...
var vriMapWdays = ["'.mb_substr(JText::_('VRISUNDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::_('VRIMONDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::_('VRITUESDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::_('VRIWEDNESDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::_('VRITHURSDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::_('VRIFRIDAY'), 0, 3, 'UTF-8').'", "'.mb_substr(JText::_('VRISATURDAY'), 0, 3, 'UTF-8').'"];
var vriMapMons = ["'.mb_substr(JText::_('VRMONTHONE'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHTWO'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHTHREE'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHFOUR'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHFIVE'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHSIX'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHSEVEN'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHEIGHT'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHNINE'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHTEN'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHELEVEN'), 0, 3, 'UTF-8').'","'.mb_substr(JText::_('VRMONTHTWELVE'), 0, 3, 'UTF-8').'"];';
	...
	<div class="vri-ratesoverview-itemsel-block">
		<form method="get" action="index.php?option=com_vikrentitems" name="vriratesovwform">
			...
			<div class="vri-ratesoverview-itemsel-entry vri-ratesoverview-itemsel-entry-chitems">
				<label for="itemsel"><?php echo JText::_('VRIRATESOVWITEM'); ?></label>
			...
			<div class="vri-ratesoverview-itemsel-entry vri-ratesoverview-itemsel-entry-calc">
				<div class="vri-ratesoverview-itemsel-entry-calc-inner">
					<label for="itemselcalc"><?php echo JText::_('VRIRATESOVWRATESCALCULATOR'); ?></label>
					...
					<span class="vri-ratesoverview-entryinline">
						<?php echo $vri_app->getCalendar('', 'pickupdate', 'pickupdate', '%Y-%m-%d', array('class'=>'', 'size'=>'10', 'maxlength'=>'19', 'todayBtn' => 'true', 'placeholder'=>JText::_('VRPICKUPAT'))); ?>
					</span>
					<span class="vri-ratesoverview-entryinline">
						<span><?php echo JText::_('VRDAYS'); ?></span> <input type="number" id="vri-numdays" value="1" min="1" max="999" step="1" />
					</span>
					<span class="vri-ratesoverview-entryinline">
						<button type="button" class="btn vri-config-btn" id="vri-ratesoverview-calculate"><?php echo JText::_('VRIRATESOVWRATESCALCULATORCALC'); ?></button>
					</span>
				</div>
			...
			<div class="vri-ratesoverview-itemsel-entry vri-ratesoverview-itemsel-entry-los"<?php echo (!empty($cookie_tab) && $cookie_tab == 'cal' ? ' style="display: none;"' : ''); ?>>
				<label><?php echo JText::_('VRIRATESOVWNUMNIGHTSACT'); ?></label>
			<?php
			...
			?>
				...
				<button type="button" class="btn vri-config-btn vri-apply-los-btn" onclick="document.vriratesovwform.submit();"><?php echo JText::_('VRIRATESOVWAPPLYLOS'); ?></button>
			</div>
		</form>
	</div>
...
<div class="vri-ratesoverview-bottom-container">
	...
	<div class="vri-ratesoverview-bottom-head">
		...
		<div class="vri-ratesoverview-tabscont">
			<div class="vri-ratesoverview-tab-cal <?php echo (!empty($cookie_tab) && $cookie_tab == 'cal' ? 'vri-ratesoverview-tab-active' : 'vri-ratesoverview-tab-unactive'); ?>"><i class="vriicn-calendar"></i> <?php echo JText::_('VRIRATESOVWTABCALENDAR'); ?></div>
			<div class="vri-ratesoverview-tab-los <?php echo (!empty($cookie_tab) && $cookie_tab == 'cal' ? 'vri-ratesoverview-tab-unactive' : 'vri-ratesoverview-tab-active'); ?>"><i class="vriicn-clock"></i> <?php echo JText::_('VRIRATESOVWTABLOS'); ?></div>
		</div>
	</div>
			<?php
		}
				...
				<table class="vriverviewtable vriratesoverviewtable vri-table" data-iditem="<?php echo $rid; ?>">
					...
					?>
						<tr class="vri-roverviewtableavrow">
							<td><span class="vri-roverview-itemunits"><?php echo $itemrow['units']; ?></span><span class="vri-roverview-uleftlbl"><?php echo JText::_('VRPCHOOSEBUSYCAVAIL'); ?></span></td>
						<?php
						$nowts = getdate($tsstart);
						$cell_count = 0;
						while ($cell_count < $MAX_DAYS) {
			...
			<div class="vri-ratesoverview-period-container">
				<div class="vri-ratesoverview-period-inner">
					<div class="vri-ratesoverview-period-lbl">
						<span><?php echo JText::_('VRIROVWSELPERIOD'); ?></span>
					</div>
						...
						<div class="vri-ratesoverview-period-boxes-inner">
							<div class="vri-ratesoverview-period-box-left">
								<div class="vri-ratesoverview-period-box-lbl">
									<span><?php echo JText::_('VRIROVWSELPERIODFROM'); ?></span>
								</div>
							...
							<div class="vri-ratesoverview-period-box-right">
								<div class="vri-ratesoverview-period-box-lbl">
									<span><?php echo JText::_('VRIROVWSELPERIODTO'); ?></span>
								</div>
								<div class="vri-ratesoverview-period-box-val">
						...
						<div class="vri-ratesoverview-period-box-cals" style="display: none;">
							<div class="vri-ratesoverview-period-box-cals-inner">
								<div class="vri-ratesoverview-period-cal-left">
									<h4><?php echo JText::_('VRIROVWSELPERIODFROM'); ?></h4>
								...
								<div class="vri-ratesoverview-period-cal-right">
									<h4><?php echo JText::_('VRIROVWSELPERIODTO'); ?></h4>
								...
								<div class="vri-ratesoverview-period-cal-cmd">
									<h4><?php echo JText::_('VRIROVWSELRPLAN'); ?></h4>
			...
			<ul id="vri-timeline">
				...
				foreach ($seasons_cal['seasons'] as $ks => $timeseason) {
					...
					if (empty($timeseason['year'])) {
						$s_explanation[] = JText::_('VRISEASONANYYEARS');
					}
					if (!empty($timeseason['losoverride'])) {
						$s_explanation[] = JText::_('VRISEASONBASEDLOS');
					}
					?>
				<li data-fromts="<?php echo $timeseason['from_ts']; ?>" data-tots="<?php echo $timeseason['to_ts']; ?>">
					...
					<div class="vri-timeline-content">
						<p>
							<span class="vri-seasons-calendar-slabel vri-seasons-calendar-season-<?php echo $timeseason['type'] == 2 ? 'discount' : 'charge'; ?>"><?php echo $timeseason['type'] == 2 ? '-' : '+'; ?> <?php echo $s_val_diff; ?> <?php echo JText::_('VRISEASONPERDAY'); ?></span>
							<br/>
							<?php
		...
		<div class="table-responsive">
			<table class="table vri-seasons-calendar-table">
				...
				<tr class="vri-seasons-calendar-offseasonrow">
					<td>
						<span class="vri-seasons-calendar-offseasonname"><?php echo JText::_('VRISEASONSCALOFFSEASONPRICES'); ?></span>
					</td>
				<?php
				...
				<tr class="vri-seasons-calendar-seasonrow">
					...
					if ($los_show && array_key_exists($s_id, $seasons_cal['restrictions']) && count($restr_diff_nights) == 0) {
						...
						if ($season_restrictions['minlos'] > 1) {
							?>
							<span class="vri-seasons-calendar-restriction-minlos"><?php echo JText::_('VRIRESTRMINLOS'); ?><span class="vri-seasons-calendar-restriction-minlos-badge"><?php echo $season_restrictions['minlos']; ?></span></span>
							<?php
						}
						if (array_key_exists('maxlos', $season_restrictions) && $season_restrictions['maxlos'] > 1) {
							?>
							<span class="vri-seasons-calendar-restriction-maxlos"><?php echo JText::_('VRIRESTRMAXLOS'); ?><span class="vri-seasons-calendar-restriction-maxlos-badge"><?php echo $season_restrictions['maxlos']; ?></span></span>
							<?php
						}
						if (array_key_exists('wdays', $season_restrictions) && count($season_restrictions['wdays']) > 0) {
							...
							<div class="vri-seasons-calendar-restriction-wdays">
								<label><?php echo JText::_((count($season_restrictions['wdays']) > 1 ? 'VRIRESTRARRIVWDAYS' : 'VRIRESTRARRIVWDAY')); ?></label>
							<?php
							...
							<div class="vri-seasons-calendar-restriction-wdays vri-seasons-calendar-restriction-cta">
								<label><?php echo JText::_('VRIRESTRWDAYSCTA'); ?></label>
								<?php
							...
							<div class="vri-seasons-calendar-restriction-wdays vri-seasons-calendar-restriction-ctd">
								<label><?php echo JText::_('VRIRESTRWDAYSCTD'); ?></label>
								<?php
			...
			?>
		<p class="vri-warning"><?php echo JText::_('VRNOPRICESFOUND'); ?></p>
			<?php
		}
		?>
	</div>
	...
	<div class="vri-info-overlay-content vri-info-overlay-content-rovervw">
		...
		<div class="vri-roverw-setnewrate">
			<div class="vri-roverw-newrwrap">
				<h4><i class="vriicn-calculator"></i><?php echo JText::_('VRIRATESOVWSETNEWRATE'); ?></h4>
			...
			<div class="vri-roverw-setnewrate-btns">
				<button type="button" class="btn btn-danger" onclick="hideVriDialog();"><?php echo JText::_('VRANNULLA'); ?></button>
				<button type="button" class="btn btn-success" onclick="setNewRates();"><i class="vriicn-checkmark"></i><?php echo JText::_('VRAPPLY'); ?></button>
			</div>
		</div>
		<div class="vri-roverw-closeopenrp">
			<h4><i class="vriicn-switch"></i><?php echo JText::_('VRIRATESOVWCLOSEOPENRRP'); ?> <span id="rovervw-closeopen-rplan"></span></h4>
			<div class="vri-roverw-closeopenrp-btns">
				<button type="button" class="btn btn-danger" onclick="modItemRatePlan('close');"><i class="vriicn-exit"></i><?php echo JText::_('VRIRATESOVWCLOSERRP'); ?></button>
				<button type="button" class="btn btn-success" onclick="modItemRatePlan('open');"><i class="vriicn-enter"></i><?php echo JText::_('VRIRATESOVWOPENRRP'); ?></button>
				<br clear="all" /><br />
				<button type="button" class="btn btn-danger" onclick="hideVriDialog();"><?php echo JText::_('VRANNULLA'); ?></button>
			</div>
		</div>
...
var roverw_messages = {
	"setNewRatesMissing": "<?php echo addslashes(JText::_('VRIRATESOVWERRNEWRATE')); ?>",
	"modRplansMissing": "<?php echo addslashes(JText::_('VRIRATESOVWERRMODRPLANS')); ?>",
	"openSpLink": "<?php echo addslashes(JText::_('VRIRATESOVWOPENSPL')); ?>"
};
</script>
<script type="text/Javascript">
...
jQuery(document).ready(function() {
	...
	jQuery('#vri-ratesoverview-calculate').click(function() {
		jQuery(this).text('<?php echo addslashes(JText::_('VRIRATESOVWRATESCALCULATORCALCING')); ?>').prop('disabled', true);
		...
		var jqxhr = jQuery.ajax({
			...
			if (res.indexOf('e4j.error') >= 0 ) {
				...
				var titlecont = '<span class="vri-ratesoverview-calculation-response-item-name">'+jQuery("#itemselcalc option:selected").text() + '</span> ' + pickupdate + ', ' + days + ' <?php echo addslashes(JText::_('VRDAYS')); ?>';
				...
				jQuery('.vri-calcrates-rateblock').each(function(k, v) {
					...
					var booknow = '<a href="' + base_booknow_link + '" class="btn btn-primary vri-item-booknow-rct" target="_blank"><?php echo addslashes(JText::_('VRIBOOKNOW')); ?></a>';
					elem.append(booknow);
				});
				//
			}
			jQuery('#vri-ratesoverview-calculate').text('<?php echo addslashes(JText::_('VRIRATESOVWRATESCALCULATORCALC')); ?>').prop('disabled', false);
		}).fail(function() { 
