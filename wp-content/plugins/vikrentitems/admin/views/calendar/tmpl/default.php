...
if (strlen($msg) > 0 && intval($msg) > 0) {
	?>
<p class="successmade"><?php echo JText::_('VRBOOKMADE'); ?> &nbsp;&nbsp;&nbsp; <a href="index.php?option=com_vikrentitems&task=editorder&cid[]=<?php echo intval($msg); ?>" class="btn"><?php VikRentItemsIcons::e('eye'); ?> <?php echo JText::_('VRIVIEWBOOKINGDET'); ?></a></p>
	<?php
...
<div class="vri-admin-container">
			...
			<div class="vri-params-wrap">
				<legend class="adminlegend">
					<div class="vri-quickres-head">
						<span><?php echo $itemrows['name'] . " - " . JText::_('VRQUICKBOOK'); ?></span>
				...
				<form name="newb" method="post" action="index.php?option=com_vikrentitems" onsubmit="javascript: if (!document.newb.pickupdate.value.match(/\S/)){alert('<?php echo addslashes(JText::_('VRMSGTHREE')); ?>'); return false;} if (!document.newb.releasedate.value.match(/\S/)){alert('<?php echo addslashes(JText::_('VRMSGFOUR')); ?>'); return false;} return true;">
					<div class="vri-params-container">
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRDATEPICKUP'); ?></div>
							<div class="vri-param-setting">
								...
								<span class="vri-calendar-time-inline"><?php echo JText::_('VRAT'); ?></span>
								<select name="pickuph"><?php echo $hours; ?></select> : <select name="pickupm"><?php echo $minutes; ?></select>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRDATERELEASE'); ?></div>
							<div class="vri-param-setting">
								<div class="input-append">
						...
						<div class="vri-param-container">
							<div class="vri-param-label">
								<span class="vricloseitemsp">
									<label for="setclosed-on"><?php echo JText::_('VRICLOSEITEM'); ?> <i class="<?php echo VikRentItemsIcons::i('ban'); ?>" style="float: none;"></i></label>
								</span>
							</div>
							<div class="vri-param-setting">
								<?php echo $vri_app->printYesNoButtons('setclosed', JText::_('VRYES'), JText::_('VRNO'), 0, 1, 0, 'vriCloseItem();'); ?>
							</div>
						</div>
					<?php
					if ($itemrows['units'] > 1) {
						...
						<div class="vri-param-container" id="vrspannumitems">
							<div class="vri-param-label"><?php echo JText::_('VRIQUANTITY'); ?></div>
							<div class="vri-param-setting">
					...
					if (count($pickuparr) && count($dropoffarr)) {
						...
						<div class="vri-param-container" id="vrspanblocations">
							<div class="vri-param-label"><?php echo JText::_('VRIQUICKRESLOCATIONS'); ?></div>
							<div class="vri-param-setting">
					...
					?>
						<div class="vri-param-container" id="vrspanbstat">
							<div class="vri-param-label"><?php echo JText::_('VRIQUICKRESORDSTATUS'); ?></div>
							<div class="vri-param-setting">
						...
						<div class="vri-param-container" id="vrspanbpay">
							<div class="vri-param-label"><?php echo JText::_('VRIQUICKRESMETHODOFPAYMENT'); ?></div>
							<div class="vri-param-setting">
					...
					if (intval(VikRentItems::getItemParam($itemrows['params'], 'delivery')) == 1) {
						...
						<div class="vri-param-container" id="vrspanbdeliveraddr">
							<div class="vri-param-label"><?php echo JText::_('VRIQUICKRESDELIVERYADDR'); ?></div>
							<div class="vri-param-setting">
								<input type="text" name="deliveryaddr" size="20" value=""/>
							</div>
						</div>
						<div class="vri-param-container" id="vrspanbdeliverdist">
							<div class="vri-param-label"><?php echo JText::_('VRIQUICKRESDELIVERYDIST'); ?></div>
							<div class="vri-param-setting">
					...
					?>
						...
						<div class="vri-param-container" id="vrspancmail">
							<div class="vri-param-label"><?php echo JText::_('VRQRCUSTMAIL'); ?></div>
							<div class="vri-param-setting">
								<input type="text" name="custmail" id="custmailfield" value="" size="25"/>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRCUSTINFO'); ?></div>
							<div class="vri-param-setting">
						...
						<div class="vri-param-container" id="vri-website-rates-row" style="display: none;">
							<div class="vri-param-label"><?php echo JText::_('VRIWEBSITERATES'); ?></div>
							<div class="vri-param-setting" id="vri-website-rates-cont"></div>
						</div>
						<div class="vri-param-container" id="vrspcustcost">
							<div class="vri-param-label"><?php echo JText::_('VRIRENTCUSTRATEPLANADD'); ?></div>
							<div class="vri-param-setting">
								<span>
						...
						<div class="vri-param-container">
							<div class="vri-param-label">&nbsp;</div>
							<div class="vri-param-setting">
								<button type="submit" id="quickbsubmit" class="btn btn-success btn-large"><?php VikRentItemsIcons::e('save'); ?> <span><?php echo JText::_('VRMAKERESERV'); ?></span></button>
							</div>
						</div>
					</div>
					<?php
	...
	<div class="vri-config-maintab-right">
		...
		if (empty($busy)) {
			...
			?>
			<p>
				<a class="vrmodelink<?php echo $vmode == 3 ? ' vrmodelink-active' : ''; ?>" href="index.php?option=com_vikrentitems&amp;task=calendar&amp;cid[]=<?php echo $itemrows['id'].($ptmpl == 'component' ? '&tmpl=component' : ''); ?>&amp;vmode=3"><?php VikRentItemsIcons::e('calendar'); ?> <span><?php echo JText::_('VRTHREEMONTHS'); ?></span></a>
				<a class="vrmodelink<?php echo $vmode == 6 ? ' vrmodelink-active' : ''; ?>" href="index.php?option=com_vikrentitems&amp;task=calendar&amp;cid[]=<?php echo $itemrows['id'].($ptmpl == 'component' ? '&tmpl=component' : ''); ?>&amp;vmode=6"><?php VikRentItemsIcons::e('calendar'); ?> <span><?php echo JText::_('VRSIXMONTHS'); ?></span></a>
				<a class="vrmodelink<?php echo $vmode == 12 ? ' vrmodelink-active' : ''; ?>" href="index.php?option=com_vikrentitems&amp;task=calendar&amp;cid[]=<?php echo $itemrows['id'].($ptmpl == 'component' ? '&tmpl=component' : ''); ?>&amp;vmode=12"><?php VikRentItemsIcons::e('calendar'); ?> <span><?php echo JText::_('VRTWELVEMONTHS'); ?></span></a>
				<a class="vrmodelink" href="javascript: void(0);" onclick="jQuery('#icalsynclinkinp').attr('size', (jQuery('#icalsynclinkinp').val().length + 5)).fadeToggle().focus();"><?php VikRentItemsIcons::e('link'); ?> <span><?php echo JText::_('VRIICALLINK'); ?></span></a>
	...
	<div class="vri-calendar-cfields-filler">
		<div class="vri-calendar-cfields-topcont">
			...
			<div class="vri-calendar-cfields-search">
				<label for="vri-searchcust"><?php echo JText::_('VRISEARCHEXISTCUST'); ?></label>
				<span id="vri-searchcust-loading">
					<i class="vriicn-hour-glass"></i>
				</span>
				<input type="text" id="vri-searchcust" autocomplete="off" value="" placeholder="<?php echo JText::_('VRISEARCHCUSTBY'); ?>" size="35" />
...
function vriCloseItem() {
	...
	if (ckbox && ckbox.checked == true) {
		...
		jQuery("#vricustdatatxtarea").val("<?php echo addslashes(JText::_('VRDBTEXTROOMCLOSED')); ?>");
