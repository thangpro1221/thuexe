				...
				<div class="vri-params-wrap">
					...
					<div class="vri-params-container">
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWCARATONE'); ?></div>
							<div class="vri-param-setting">
								<input type="text" name="caratname" value="<?php echo count($row) ? htmlspecialchars($row['name']) : ''; ?>" size="40"/>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWCARATTWO'); ?></div>
							<div class="vri-param-setting">
								...
								<div class="vri-param-setting-block">
									...
									<span id="resizesel" style="display: none;">&nbsp;
										<?php echo JText::_('VRNEWOPTTEN'); ?>: <input type="number" name="resizeto" value="50" min="0"/> px
									</span>								
								</div>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWCARATTHREE'); ?></div>
							<div class="vri-param-setting">
		...
		<div class="vri-config-maintab-right">
			<fieldset class="adminform">
				<div class="vri-params-wrap">
					...
					<div class="vri-params-container">
						<div class="vri-param-container">
							<div class="vri-param-label"> <?php echo JText::_('VRIITEMSASSIGNED'); ?></div>
							<div class="vri-param-setting"> 
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPOSITIONORDERING'); ?></div>
							<div class="vri-param-setting">
								<input type="number" name="ordering" value="<?php echo count($row) ? $row['ordering'] : ''; ?>"/>
							<?php
							if (!count($row)) {
								?>
								<span class="vri-param-setting-comment"><?php echo JText::_('VRIPOSITIONORDERINGHELP'); ?></span>
								<?php
							}
							?>
							</div>
