...
if (count($morei)) {
	foreach ($morei as $ki => $mi) {
		if (!empty($mi)) {
			...
			$actmoreimgs .= '<a class="vri-rm-extraimg-lnk" onclick="return confirm(\'' . addslashes(JText::_('VRIDELCONFIRM')) . '\');" href="index.php?option=com_vikrentitems&task=removemoreimgs&elemid='.$row['id'].'&imgind='.$ki.'"><i class="'.VikRentItemsIcons::i('times-circle').'"></i></a>';
...
<form name="adminForm" id="adminForm" action="index.php" method="post" enctype="multipart/form-data">
	<div class="vri-admin-container">
		<div class="vri-config-maintab-left">
				...
				<div class="vri-params-wrap">
					...
					<div class="vri-params-container">
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMFIVE'); ?></div>
							<div class="vri-param-setting"><input type="text" name="cname" value="<?php echo count($row) ? htmlspecialchars($row['name']) : ''; ?>" size="40"/></div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMEIGHT'); ?></div>
							<div class="vri-param-setting">
								<?php echo $vri_app->printYesNoButtons('cavail', JText::_('VRYES'), JText::_('VRNO'), ((count($row) && intval($row['avail']) == 1) || !count($row) ? 'yes' : 0), 'yes', 0); ?>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMNINE'); ?></div>
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMSIX'); ?></div>
							<div class="vri-param-setting">
								...
								<div class="vri-param-setting-block">
									...
									<span id="resizesel" style="display: none;"><span><?php echo JText::_('VRNEWOPTTEN'); ?></span><input class="vri-small-input" type="text" name="resizeto" value="250" size="3"/> px</span>
								</div>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label">
								<div class="vri-param-label-top">
									...
									<a class="btn vri-config-btn" href="javascript: void(0);" onclick="addMoreImages();"><?php VikRentItemsIcons::e('plus-circle'); ?> <?php echo JText::_('VRADDIMAGES'); ?></a>
								</div>
							</div>
							<div class="vri-param-setting">
								<div class="vri-param-setting-block">
								...
								<div class="vri-param-setting-block">
									...
									<span id="resizeselmore" style="display: none;"><span><?php echo JText::_('VRNEWOPTTEN'); ?></span><input class="vri-small-input" type="text" name="resizetomore" value="600" size="3"/> px</span>
								</div>
							</div>
						</div>
					<?php
					if (is_array($cats) && count($cats)) {
						?>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMONE'); ?></div>
							<div class="vri-param-setting">
					...
					if (is_array($places) && count($places)) {
						...
						?>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMTWO'); ?></div>
							<div class="vri-param-setting">
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMDROPLOC'); ?></div>
							<div class="vri-param-setting">
					...
					if (is_array($carats) && count($carats)) {
						?>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMTHREE'); ?></div>
							<div class="vri-param-setting">
					...
					if (is_array($optionals) && count($optionals)) {
						?>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMFOUR'); ?></div>
							<div class="vri-param-setting">
								<div class="vri-itementries-cont">
								<?php
								$nn = 0;
					...
					if (count($all_items) > 0) {
						?>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMISGROUP'); ?></div>
							<div class="vri-param-setting">
								<?php echo $vri_app->printYesNoButtons('isgroup', JText::_('VRYES'), JText::_('VRNO'), (count($row) && $row['isgroup'] > 0 ? 1 : 0), 1, 0, 'toggleGroupItems(this.checked);'); ?>
								<div id="itemgroupcont" class="itemgroupcont" style="display: <?php echo count($row) && $row['isgroup'] > 0 ? "block" : "none"; ?>;">
									<p><strong><?php echo JText::_('VRNEWITEMISGROUPSEL'); ?></strong></p>
			...
			<fieldset class="adminform">
				<div class="vri-params-wrap">
					<legend class="adminlegend"><?php echo JText::_('VRNEWITEMPARAMETERS'); ?></legend>
					<div class="vri-params-container">
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIUSTSTARTINGFROM'); ?></div>
							<div class="vri-param-setting">
								<?php echo $currencysymb; ?> &nbsp; <input type="number" step="any" name="startfrom" value="<?php echo count($row) ? $row['startfrom'] : ''; ?>"/> 
								&nbsp;&nbsp; 
								<?php echo $vri_app->createPopover(array('title' => JText::_('VRIUSTSTARTINGFROM'), 'content' => JText::_('VRIUSTSTARTINGFROMHELP'))); ?>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRICUSTSTARTINGFROMTEXT'); ?></div>
							<div class="vri-param-setting">
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIASKQUANTITY'); ?></div>
							<div class="vri-param-setting">
								<?php echo $vri_app->printYesNoButtons('askquantity', JText::_('VRYES'), JText::_('VRNO'), ((count($row) && intval($row['askquantity']) == 1) || !count($row) ? 'yes' : 0), 'yes', 0, 'toggleMinQuantity(this.checked);'); ?>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPARAMITEMSHOWDISCQUANTAB'); ?></div>
							<div class="vri-param-setting">
								<?php echo $vri_app->printYesNoButtons('discsquantstab', JText::_('VRYES'), JText::_('VRNO'), ((count($row) && intval(VikRentItems::getItemParam($row['params'], 'discsquantstab')) == 1) || !count($row) ? 'yes' : 0), 'yes', 0); ?>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIHOURLYCALENDAR'); ?></div>
							<div class="vri-param-setting">
								<?php echo $vri_app->printYesNoButtons('hourlycalendar', JText::_('VRYES'), JText::_('VRNO'), ((count($row) && intval(VikRentItems::getItemParam($row['params'], 'hourlycalendar')) == 1) || !count($row) ? 'yes' : 0), 'yes', 0); ?>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIUSETIMESLOTS'); ?></div>
							<div class="vri-param-setting">
								<?php echo $vri_app->printYesNoButtons('timeslots', JText::_('VRYES'), JText::_('VRNO'), ((count($row) && intval(VikRentItems::getItemParam($row['params'], 'timeslots')) == 1) || !count($row) ? 'yes' : 0), 'yes', 0); ?>
								&nbsp;&nbsp; 
								<?php echo $vri_app->createPopover(array('title' => JText::_('VRIUSETIMESLOTS'), 'content' => JText::_('VRIUSETIMESLOTSHELP'))); ?>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIUSEDELIVERY'); ?></div>
							<div class="vri-param-setting">
								<?php echo $vri_app->printYesNoButtons('delivery', JText::_('VRYES'), JText::_('VRNO'), (count($row) && intval(VikRentItems::getItemParam($row['params'], 'delivery')) == 1 ? 'yes' : 0), 'yes', 0, 'toggleDeliveryCost();'); ?>
								<div id="overdeliverycost" style="display: <?php echo (count($row) && intval(VikRentItems::getItemParam($row['params'], 'delivery')) == 1 ? "block" : "none"); ?>;">
									<?php echo JText::_('VRIOVERDELIVERY'); ?> 
						...
						<div class="vri-param-container" id="minitemquant" style="display: <?php echo ((count($row) && intval($row['askquantity']) == 1) || !count($row) ? "" : "none"); ?>;">
							<div class="vri-param-label"><?php echo JText::_('VRIMINITEMQUANTITY'); ?></div>
							<div class="vri-param-setting">
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIAUTOSETDROPDAY'); ?></div>
							<div class="vri-param-setting">
								<input type="number" name="dropdaysplus" min="0" value="<?php echo count($row) ? VikRentItems::getItemParam($row['params'], 'dropdaysplus') : '0'; ?>" style="width: 50px !important;"/> <?php echo JText::_('VRIDAYSAFTERPICKUP'); ?>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIEXTRAEMAILITEM'); ?></div>
							<div class="vri-param-setting">
		...
		<div class="vri-config-maintab-right">
			<fieldset class="adminform">
				<div class="vri-params-wrap">
					<legend class="adminlegend"><?php echo JText::_('VRIDESCRIPTIONS'); ?></legend>
					<div class="vri-params-container">
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRITEMSHORTDESCR'); ?></div>
							<div class="vri-param-setting"><textarea name="shortdesc" rows="5" cols="40"><?php echo count($row) ? $row['shortdesc'] : ''; ?></textarea></div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRNEWITEMSEVEN'); ?></div>
							<div class="vri-param-setting">
								<?php
			...
			<fieldset class="adminform">
				<div class="vri-params-wrap">
					<legend class="adminlegend"><?php echo JText::_('VRNEWITEMSEFPARAMETERS'); ?></legend>
					<div class="vri-params-container">
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPARAMPAGETITLE'); ?></div>
							<div class="vri-param-setting">
						...
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPARAMKEYWORDSMETATAG'); ?></div>
							<div class="vri-param-setting">
								<textarea name="metakeywords" id="metakeywords" rows="3" cols="40"><?php echo htmlspecialchars($item_jsparams['metakeywords']); ?></textarea>
							</div>
						</div>
						<div class="vri-param-container">
							<div class="vri-param-label"><?php echo JText::_('VRIPARAMDESCRIPTIONMETATAG'); ?></div>
							<div class="vri-param-setting">
