			...
			<div class="vri-menu-right">
				<ul class="vri-menu-ul"><?php
					...
					?><li class="vri-menu-parent-li">
						<span><?php VikRentItemsIcons::e('truck-moving'); ?> <a href="javascript: void(0);"><?php echo JText::_('VRMENUONE'); ?></a></span>
						...
						if ($vri_auth_prices) {
							...
							<li><span class="<?php echo ($highlight=="restrictions" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=restrictions"><?php echo JText::_('VRMENURESTRICTIONS'); ?></a></span></li>
							<?php
						}
						?>
						</ul>
					...
					if ($vri_auth_items) {
					?><li class="vri-menu-parent-li">
						<span><?php VikRentItemsIcons::e('layer-group'); ?> <a href="javascript: void(0);"><?php echo JText::_('VRMENUTWO'); ?></a></span>
						<ul class="vri-submenu-ul">
					...
					if ($vri_auth_prices) {
					?><li class="vri-menu-parent-li">
						<span><?php VikRentItemsIcons::e('calculator'); ?> <a href="javascript: void(0);"><?php echo JText::_('VRIMENUFARES'); ?></a></span>
						<ul class="vri-submenu-ul">
							...
							<li><span class="<?php echo ($highlight=="ratesoverv" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=ratesoverv"><?php echo JText::_('VRIMENURATESOVERVIEW'); ?></a></span></li>
						</ul>
					</li><?php
					}
					?><li class="vri-menu-parent-li">
						<span><?php VikRentItemsIcons::e('calendar-check'); ?> <a href="javascript: void(0);"><?php echo JText::_('VRMENUTHREE'); ?></a></span>
						...
						?>
							...
							<li><span class="<?php echo ($highlight=="15" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=overv"><?php echo JText::_('VRMENUTENNINE'); ?></a></span></li><?php
						}
					...
					?><li class="vri-menu-parent-li">
						<span><?php VikRentItemsIcons::e('chart-line'); ?> <a href="javascript: void(0);"><?php echo JText::_('VRIMENUMANAGEMENT'); ?></a></span>
						<ul class="vri-submenu-ul">
							...
							<li><span class="<?php echo ($highlight=="crons" ? "vmenulinkactive" : "vmenulink"); ?>"><a href="index.php?option=com_vikrentitems&amp;task=crons"><?php echo JText::_('VRIMENUCRONS'); ?></a></span></li>
						</ul>
					</li><?php
					}
					if ($vri_auth_gsettings) {
					?><li class="vri-menu-parent-li">
						<span><?php VikRentItemsIcons::e('cogs'); ?> <a href="javascript: void(0);"><?php echo JText::_('VRMENUFOUR'); ?></a></span>
						<ul class="vri-submenu-ul">
			...
			if (!VikRentItemsLicense::isPro()) {
				?>
					<button type="button" class="vri-gotopro" onclick="document.location.href='admin.php?option=com_vikrentitems&view=gotopro';">
						...
						<span><?php echo JText::_('VRIGOTOPROBTN'); ?></span>
					</button>
				<?php
			} else {
				?>
					<button type="button" class="vri-alreadypro" onclick="document.location.href='admin.php?option=com_vikrentitems&view=gotopro';">
						...
						<span><?php echo JText::_('VRIISPROBTN'); ?></span>
					</button>
				<?php
			}
			?>
