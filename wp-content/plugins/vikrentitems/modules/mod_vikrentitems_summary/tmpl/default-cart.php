	...
	<div class="vri-modsummarycart-cont">
		<div class="vri-modsummarycart-top">
			<div class="vri-modsummarycart-top-inner">
				<span class="vri-modsummarycart-yourcart"><?php echo JText::_('VRIMCARTYOURCART'); ?></span><span class="vri-modsummarycart-totitems"><?php echo JText::sprintf('VRIMCARTTOTITEMS', $totitems); ?></span>
			</div>
		</div>
	<?php
if ($totitems > 0) {
		...
		if (array_key_exists('hours', $price)) {
			?>
				<div class="vrimodsumrentalfor">
					<div class="vrirentalfortwomodsum"><p><?php echo JText::_('VRMDAL'); ?> <span class="vrirentalfordatemodsum"><?php echo date($jsdf.' '.$tf, $vrisesspickup); ?></span></p><p><?php echo JText::_('VRMAL'); ?> <span class="vrirentalfordatemodsum"><?php echo date($tf, $vrisessdropoff); ?></span></p></div>
				</div>
			<?php
		} else {
			?>
				<div class="vrimodsumrentalfor">
					<div class="vrirentalfortwomodsum"><p><?php echo JText::_('VRMDAL'); ?> <span class="vrirentalfordatemodsum"><?php echo date($jsdf.' '.$tf, $vrisesspickup); ?></span></p><p><?php echo JText::_('VRMAL'); ?> <span class="vrirentalfordatemodsum"><?php echo date($jsdf.' '.$tf, $vrisessdropoff); ?></span></p></div>
				</div>
			<?php
		}
		?>
	...
	?>
			<div class="vri-modsummarycart-bottom-innermiddle">
				<span class="vri-modsummarycart-yourtot"><?php echo JText::_('VRIMTMPTOTDUE'); ?></span><span class="vri-modsummarycart-tot"><?php echo $currencysymb.' '.ModVikrentitemsSummaryHelper::numberFormat($totdue, 2); ?></span>
			</div>
	...
	if (intval($params->get('showgotosumm')) == 1) {
		?>
				<div class="vrimodsummarygosummary">
					<a class="btn" href="<?php echo JRoute::_('index.php?option=com_vikrentitems&task=oconfirm&place='.$vrisesspickuploc.'&returnplace='.$vrisessdropoffloc.'&days='.$vrisessdays.'&pickup='.$vrisesspickup.'&release='.$vrisessdropoff.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VRIMGOTOSUMMARY'); ?></a>
				</div>
		<?php
	}
	?>
