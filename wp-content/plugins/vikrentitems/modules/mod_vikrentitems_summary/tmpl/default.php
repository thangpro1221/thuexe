	...
	?>
		<div class="vrimodsummarytotitemsdiv">
			<div class="vrimodsummarytotitems">
				<span><?php echo JText::_('VRIMTOTITEMS'); ?></span><span class="vrimodsummarynum"><?php echo $totitems; ?></span>
			</div>
			<div class="vrimodsummarytotal">
				<span><?php echo JText::_('VRIMTMPTOTDUE'); ?></span><span class="vrimodsummarynumtot"><?php echo $currencysymb.' '.ModVikrentitemsSummaryHelper::numberFormat($totdue, 2); ?></span>
			</div>
		</div>
	<?php
