...
<div class="loginregistercont">
	...
	<div class="registerblock">
		<form action="<?php echo JRoute::_('index.php?option=com_vikrentitems'); ?>" method="post" name="vrireg" onsubmit="return checkVriReg();">
			...
			?>
				<tr><td align="right">&nbsp;</td><td><input type="submit" value="<?php echo JText::_('VRREGSIGNUPBTN'); ?>" class="btn booknow" name="submit" /></td></tr>
			</table>
...
?>
	...
	<div class="loginblock">
		<form action="<?php echo $url; ?>" method="post">
			...
			<table valign="top">
				<tr><td align="right"><?php echo JText::_('VRREGUNAME'); ?></td><td><input type="text" name="log" value="" size="20" class="vriinput"/></td></tr>
				<tr><td align="right"><?php echo JText::_('VRREGPWD'); ?></td><td><input type="password" name="pwd" value="" size="20" class="vriinput"/></td></tr>
