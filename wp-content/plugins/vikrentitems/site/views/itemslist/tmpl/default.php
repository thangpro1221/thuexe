		...
		<div class="vri-list-item-block<?php echo $c['isgroup'] > 0 ? ' vri-list-item-kit-block' : ''; ?>">
			...
			<div class="vri-list-item-cont">
				<div class="vrilistcostdivcont">
					...
					?>
					<span class="vrilistgoonlist"><a href="<?php echo JRoute::_('index.php?option=com_vikrentitems&view=itemdetails&elemid='.$c['id'].(!empty($pitemid) ? '&Itemid=' . $pitemid : '')); ?>"><?php echo $c['isgroup'] > 0 ? JText::_('VRILISTKITPICK') : JText::_('VRILISTPICK'); ?></a></span>
				</div>
			</div>
		</div>
	<?php
