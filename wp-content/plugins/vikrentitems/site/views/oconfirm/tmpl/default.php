...
//
?>
<h3 class="vri-rental-summary-title"><?php echo JText::_('VRRIEPILOGOORD'); ?></h3>
...
if (is_array($vrisessioncart) && count($vrisessioncart) > 0) {
	...
	<div class="vri-oconfirm-summary-item-wrapper">
		<div class="vri-oconfirm-summary-item-head">
			...
			<div class="vri-oconfirm-summary-item-head-cell vri-oconfirm-summary-item-cell-days">
				<span><?php echo is_array($price) && array_key_exists('hours', $price) ? JText::_('VRIHOURS') : JText::_('ORDDD'); ?></span>
			</div>
		...
		<div class="vri-oconfirm-summary-item-row">
			<div class="vri-oconfirm-summary-item-cell-descr">
				...
				<div class="vri-oconfirm-item-action">
					<a href="<?php echo JRoute::_('index.php?option=com_vikrentitems&task=rmcartitem&elem='.$iditem.';'.$k.'&place='.$place.'&returnplace='.$returnplace.'&days='.$days.'&pickup='.$first.'&release='.$second); ?>" onclick="return confirm('<?php echo addslashes(JText::_('VRICARTCONFRMITEM')); ?>');"><?php VikRentItemsIcons::e('trash-alt'); ?></a>
				</div>
			</div>
			<div class="vri-oconfirm-summary-item-cell-days">
				...
				<span><?php echo (array_key_exists('timeslot', $itemarr) ? $itemarr['timeslot']['name'] : (array_key_exists('hours', $itemarr['price']) ? $itemarr['price']['hours'].($dailyandhourlyrates === true ? " (".JText::_('VRIHOURS').")" : "") : $days.($dailyandhourlyrates === true ? " (".JText::_('VRDAY').")" : ""))); ?></span>
			</div>
		...
		<div class="vri-oconfirm-summary-item-row vri-oconfirm-summary-extracost-row">
			<div class="vri-oconfirm-summary-item-cell-descr">
				<div class="vri-oconfirm-extracostname">
					<span class="vri-summary-deliveryto-lbl"><?php echo JText::_('VRISUMMARYDELIVERYTO'); ?></span>
	...
	<div class="vri-oconfirm-summary-item-wrapper vri-oconfirm-summary-locfees-wrapper">
		<div class="vri-oconfirm-summary-item-row vri-oconfirm-summary-extracost-row">
			<div class="vri-oconfirm-summary-item-cell-descr">
				<div class="vri-oconfirm-extracostname"><?php echo JText::_('VRLOCFEETOPAY'); ?></div>
			</div>
			<div class="vri-oconfirm-summary-item-cell-days">
				<div class="vri-oconfirm-summary-item-head-cell vri-oconfirm-summary-item-head-cell-responsive">
					<span><?php echo is_array($price) && array_key_exists('hours', $price) ? JText::_('VRIHOURS') : JText::_('ORDDD'); ?></span>
	...
	if ($totdelivery > 0) {
		...
		<div class="vri-oconfirm-summary-item-row vri-oconfirm-summary-total-row vri-oconfirm-summary-delivery-row">
			<div class="vri-oconfirm-summary-item-cell-descr">
				<div class="vri-oconfirm-total-block vri-oconfirm-total-delivery-block"><?php echo JText::_('VRISUMMARYDELIVERYSERVICE'); ?></div>
			</div>
			<div class="vri-oconfirm-summary-item-cell-days">
				<span></span>
			</div>
	...
	?>
		<div class="vri-oconfirm-summary-item-row vri-oconfirm-summary-total-row">
			<div class="vri-oconfirm-summary-item-cell-descr">
				<div class="vri-oconfirm-total-block"><?php echo JText::_('VRTOTAL'); ?></div>
			</div>
			<div class="vri-oconfirm-summary-item-cell-days">
				<span></span>
			</div>
	...
	if ($usedcoupon === true) {
		...
		<div class="vri-oconfirm-summary-item-row vri-oconfirm-summary-total-row vri-oconfirm-summary-coupon-row">
			<div class="vri-oconfirm-summary-item-cell-descr">
				<span><?php echo JText::_('VRICOUPON'); ?> <?php echo $coupon['code']; ?></span>
			</div>
			<div class="vri-oconfirm-summary-item-cell-days">
				<span></span>
			</div>
		...
		<div class="vri-oconfirm-summary-item-row vri-oconfirm-summary-total-row vri-oconfirm-summary-coupon-newtot-row">
			<div class="vri-oconfirm-summary-item-cell-descr">
				<div class="vri-oconfirm-total-block"><?php echo JText::_('VRINEWTOTAL'); ?></div>
			</div>
			<div class="vri-oconfirm-summary-item-cell-days">
				<span></span>
			</div>
				...
				<form action="<?php echo JRoute::_('index.php?option=com_vikrentitems'); ?>" method="post">
					<input type="hidden" name="option" value="com_vikrentitems"/>
		  			...
		  			<div class="vri-oconfirm-relitem-top">
			  			...
			  			if (!empty($rel['img'])) {
			  				?>
			  				<img class="vrirelitemimg" alt="<?php echo $rel['name']; ?>" src="<?php echo $imgpath; ?>"/>
			  				<?php
			  			}
			  			?>
			  			</div>
			  		...
			  		<div class="vri-oconfirm-relitem-bottom">
						...
						?>
							<div class="vrirelitemsubmitdiv">
								<button type="submit" class="btn vrirelitemsubmit"><?php echo JText::_('VRIMIGHTINTERESTBOOK'); ?></button>
							</div>
						</div>
					</div>
				</form>
...
if (count($cfields)) {
	...
	foreach ($cfields as $cf) {
		...
		if (!empty($cf['poplink'])) {
			$fname = "<a href=\"" . $cf['poplink'] . "\" id=\"vrif" . $cf['id'] . "\" target=\"_blank\" class=\"vrimodal\">" . JText::_($cf['name']) . "</a>";
		} else {
		...
		<?php
			...
			foreach ($answ as $aw) {
				if (!empty($aw)) {
					$wcfsel .= "<option value=\"" . JText::_($aw) . "\"".($def_textval == JText::_($aw) ? ' selected="selected"' : '').">" . JText::_($aw) . "</option>\n";
				}
			}
			$wcfsel .= "</select>\n";
			?>
			...
			<div class="vridivcustomfield vri-oconfirm-cfield-entry vri-oconfirm-cfield-entry-checkbox">
				...
				<div class="vri-customfield-input vri-oconfirm-cfield-input">
					<input type="checkbox" name="vrif<?php echo $cf['id']; ?>" id="vrif-inp<?php echo $cf['id']; ?>" value="<?php echo JText::_('VRYES'); ?>" <?php echo !(bool)$cf['required'] && isset($customer_details['cfields']) && isset($customer_details['cfields'][$cf['id']]) ? 'checked="checked"' : ''; ?>/>
				</div>
			</div>
			<?php
		}
