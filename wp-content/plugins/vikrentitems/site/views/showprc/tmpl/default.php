...
?>
	...
	<form action="<?php echo JRoute::_('index.php?option=com_vikrentitems'); ?>" method="post">
			...
			foreach ($tars as $k => $t) {
				...
				<tr>
					...
					<td class="vri-showprc-pricetbl-cost">
						...
						if ($itemquant > 1) {
							?>
							<span class="vri-showprc-pricetbl-cost-info"><?php echo JText::_('VRIEACHUNIT'); ?></span>
							<?php
						}
						?>
						</label>
			...
			<?php
				...
				<tr class="vri-showprc-item-pickdropfees">
					<td class="vri-showprc-pricetbl-sub-name">
						<label for="pid<?php echo $t['idprice']; ?>"><?php echo JText::_('VRLOCFEETOPAY'); ?></label>
					</td>
			...
			foreach ($optionals as $k => $o) {
				...
				<tr>
					...
					<td class="vri-showprc-opttbl-price">
						...
						<?php echo ($itemquant > 1 && !$o['onceperitem'] ? JText::_('VRIEACHUNIT') : ''); ?>
					</td>
		...
		<div class="item_buttons_box">
			<button type="submit" class="btn booknow"><?php echo JText::_('VRBOOKNOW'); ?></button>
			<div class="goback">
